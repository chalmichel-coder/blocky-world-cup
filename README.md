# Blocky World Cup — Ultra Legend Edition 3.5
...
- L : tacle classique
- I : changer de joueur
- G : sélectionner directement le gardien
- P ou Échap : pause
...
La version **Ultra Legend Edition 3.5** conserve les cinématiques, le système audio, la séquence d'éditeur, le football total et l'affichage adaptatif de la version précédente. Elle adopte une ambiance de Coupe du monde destinée à un jeune joueur : couleurs lumineuses, confettis, cartes d’équipes claires, contrastes renforcés et références graphiques aux jeux de football rétro sans assombrir l’interface. Pendant le match, les supporters déploient deux grands drapeaux animés correspondant exactement aux équipes présentes sur le terrain.

## Équipes officielles 2026

Le jeu contient les **48 sélections de la Coupe du monde 2026**, auxquelles s'ajoutent le **Cambodge** et l’**Italie** en équipes bonus, soit **50 pays au total**. Chaque pays possède son drapeau dans le sélecteur et cinq joueurs visibles dans la carte d'équipe puis sur le terrain :

- **GK** : gardien / goalkeeper
- **DF** : défenseur / defender
- **MF × 2** : deux milieux / two midfielders
- **FW** : attaquant / forward

Le match se joue maintenant en **5 contre 5** : un gardien, un défenseur, deux milieux et un attaquant sont réellement utilisés par chaque équipe. Les joueurs d’une sélection appartiennent à une même génération internationale. L’Italie utilise Gianluigi Donnarumma, Alessandro Bastoni, Nicolò Barella, Sandro Tonali et Mateo Retegui.

Le placement est désormais fondé sur un système de **football total** : les quatre joueurs de champ permutent régulièrement entre pressing, couverture, soutien, débordement et appel vers le but. Ils suivent l’action et changent de responsabilité au lieu de revenir en permanence à un poste fixe.

Le gardien participe au jeu comme un gardien-libéro. L’IA peut le faire sortir de sa surface sur un ballon libre ou une attaque dangereuse. Le joueur peut le sélectionner avec **G** sur PC, avec le bouton **G** sur mobile/tablette, ou en faisant défiler les joueurs avec **I/C**. Une fois sélectionné, le gardien peut parcourir tout le terrain.
...
- **International** propose une opposition équilibrée.
- **Légende** accélère le jeu et renforce la précision ainsi que le pressing adverse.
- **Ultra Légende** transforme l’adversaire en équipe d’élite : déplacements très rapides, décisions presque immédiates, pressing et tacles renforcés, attaques plus directes et tirs beaucoup plus précis. Le gardien adverse se déplace nettement plus vite, sort davantage et dispose d’un système spécial d’anticipation lui permettant d’arrêter environ 97 % des tirs cadrés qu’il peut atteindre. Marquer reste possible, mais devient exceptionnel.
...
Les quatre affichages utilisent exactement le même moteur de match, les mêmes règles, la même physique du ballon et la même intelligence artificielle. Les noms au-dessus des joueurs utilisent maintenant une police plus grande, une étiquette plus haute et un contour renforcé pour rester lisibles sur les trois formats d’écran.
